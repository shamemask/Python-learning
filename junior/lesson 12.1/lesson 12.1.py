...
words = ['красный', "синий", "зелёный", "розовый", "чёрный", "жёлтый", "оранжевый", "фиолетовый", "коричневый"]
...
color_label = tk.Label(window, text=random.choice(words), font=("Helvetica", 60))
