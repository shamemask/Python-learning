'''
    Цель: Доделать игру Plants vs Zombies, а также создать оставшиеся классы растений и зомби.

    + Вспомнить команды из прошлых уроков;
    + Добавить в игру Стенорех;
    + Научить зомби поедать растения;
    + Сделать возможным посадку нового растения на место съеденного;
    + Добавить в игру зомби с конусом;
    + Добавить в игру Древофакел;
    + Добавить в игру зомби с ведром
    + Сделать проигрыш;
    + Добавить подсчет убитых зомби и усложнение игры;
    + Сделать победу;
